"""
Download NQH6 MBP-10 DBN data from Databento.

NQH6 (March 2026 Nasdaq-100 futures) — same exchange as ESH6 (GLBX.MDP3).
Download range: Jan 2 – Feb 28, 2026 (covers full Jan+Feb analysis window).

Usage:
    python scripts/download_nqh6_mbp10.py --dry-run
    python scripts/download_nqh6_mbp10.py --api-key db-xxx

Files saved to:
    c:/Users/majin/Downloads/NQH6-MBP10/glbx-mdp3-YYYYMMDD.mbp-10.dbn
"""
...
DOWNLOAD_ROOT = Path("c:/Users/majin/Downloads/NQH6-MBP10")
DATASET       = "GLBX.MDP3"
SCHEMA        = "mbp-10"
SYMBOLS       = ["NQH6"]
