"""
Download CLH6 MBP-10 DBN data from Databento.

CLH6 (March 2026 WTI crude) last trading day: ~Feb 20, 2026.
Download range: Jan 2 – Feb 20, 2026.

Usage:
    python scripts/download_clh6_mbp10.py --dry-run
    python scripts/download_clh6_mbp10.py --api-key db-xxx

Files saved to:
    c:/Users/majin/Downloads/CLH6-MBP10/glbx-mdp3-YYYYMMDD.mbp-10.dbn
"""
...
DOWNLOAD_ROOT = Path("c:/Users/majin/Downloads/CLH6-MBP10")
DATASET       = "GLBX.MDP3"
SCHEMA        = "mbp-10"
SYMBOLS       = ["CLH6"]

# CLH6 last trading day is ~Feb 20, 2026
